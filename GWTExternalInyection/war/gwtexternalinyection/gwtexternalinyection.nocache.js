function gwtexternalinyection(){
  ...
  gwtexternalinyection.__sendStats = sendStats;
  gwtexternalinyection.__moduleName = $intern_4;
  gwtexternalinyection.__errFn = null;
  gwtexternalinyection.__moduleBase = $intern_6;
  gwtexternalinyection.__softPermutationId = $intern_7;
  gwtexternalinyection.__computePropValue = null;
  gwtexternalinyection.__getPropMap = null;
  gwtexternalinyection.__installRunAsyncCode = function(){
  }
  ;
  gwtexternalinyection.__gwtStartLoadingFragment = function(){
    return null;
  }
  ;
  gwtexternalinyection.__gwt_isKnownPropertyValue = function(){
    return false;
  }
  ;
  gwtexternalinyection.__gwt_getMetaProperty = function(){
    return null;
  }
  ;
  ...
  gwtexternalinyection.__moduleStartupDone = function(permProps){
    var oldBindings = activeModules[$intern_4].bindings;
    activeModules[$intern_4].bindings = function(){
      var props = oldBindings?oldBindings():{};
      var embeddedProps = permProps[gwtexternalinyection.__softPermutationId];
  ...
  function installScript(filename){
    ...
    function installCode(code_0){
      ...
      script.src = code_0;
      if (gwtexternalinyection.__errFn) {
        script.onerror = function(){
          gwtexternalinyection.__errFn($intern_4, new Error($intern_22 + code_0));
        }
        ;
      }
  ...
  gwtexternalinyection.__startLoadingFragment = function(fragmentFile){
    return computeUrlForResource(fragmentFile);
  }
  ;
  gwtexternalinyection.__installRunAsyncCode = function(code_0){
    var doc = getInstallLocationDoc();
    var docbody = doc.body;
    var script = doc.createElement($intern_20);
    script.language = $intern_21;
  ...
  function processMetas(){
    ...
    gwtexternalinyection.__errFn = onLoadErrorFunc;
  }
  ...
  function computeUrlForResource(resource){
    ...
    return gwtexternalinyection.__moduleBase + resource;
  }
  ...
  function getCompiledCodeFilename(){
    ...
    ;
    gwtexternalinyection.__getPropMap = function(){
      var result = {};
    ...
    ;
    gwtexternalinyection.__computePropValue = computePropValue;
    $wnd.__gwt_activeModules[$intern_4].bindings = gwtexternalinyection.__getPropMap;
    ...
    gwtexternalinyection.__softPermutationId = softPermutationId;
  ...
  processMetas();
  gwtexternalinyection.__moduleBase = computeScriptBase();
  activeModules[$intern_4].moduleBase = gwtexternalinyection.__moduleBase;
...
gwtexternalinyection.succeeded = gwtexternalinyection();
